...
12. Delete intermediate artifacts generated by the tool runs (`.ll` files, `.xray` output, and any other scanner-generated output). Keep only `static-analysis.md`; record the relevant findings there before deleting.
